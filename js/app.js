const ingresos = [
new Ingreso("Salary", 5000),
new Ingreso ("Yard sale", 1500)
];

const egresos = [
    new Egreso("Deparment rent", 900),
...
//This function is giving format to the money that we are using (USD in this case).

 const formatoMoneda = (valor) => {
     return valor.toLocaleString("en-US",{style: "currency", currency: "USD", minimumFractionDigits:2});
}

//This function is giving format to the percentage of the money that we used.
